...
// * чтобы показать автора коммита git show fce81e4 --pretty=full (fce81e4 хэш коммита) --pretty приниаем значение объёма информации в данном случае full 
// * git позволяет указать автора при коммите git commit --author="Nikita Rybak"